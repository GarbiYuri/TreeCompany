<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Empresas na Categoria: {{ $categoria->nome }}
        </h2>
    </x-slot>
            ...
            <div class="row">
                ...
                <main>
                    <div class="pt-3 pb-2 mb-3 border-bottom border-secondary">
                        <!-- Barra de pesquisa -->
                        <form action="{{ route('categorias.empresas', $categoria->id) }}" method="GET">
                        ...
                        <div class="row">
                            @if($empresas->isEmpty())
                                <div class="alert alert-warning" role="alert">
                                    Nenhuma empresa encontrada na categoria: {{ $categoria->nome }}
                                </div>
                            @else
                                            ...
                                            <div class="card mb-4 shadow-sm card-hover">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        @endphp
                                                        @for ($i = 1; $i <= 5; $i++)
                                                            <i class="fas fa-star {{ $i <= $mediaEstrelas ? 'text-warning' : 'text-muted' }}"></i>
                                                        @endfor
                                                        <span class="ms-2">({{ number_format($mediaEstrelas, 1) }} / 5)</span>
                                                        <p><strong>Avaliações:</strong> {{ $empresa->avaliacoes->count() }}</p>
                                                    </div>
